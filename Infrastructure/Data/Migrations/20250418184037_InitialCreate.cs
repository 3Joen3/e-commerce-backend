        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComparePriceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_ProductVariantPrices_ComparePriceId",
                        column: x => x.ComparePriceId,
                        principalTable: "ProductVariantPrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariants_ProductVariantPrices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "ProductVariantPrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductOptionId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ComparePriceId",
                table: "ProductVariants",
                column: "ComparePriceId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_PriceId",
                table: "ProductVariants",
                column: "PriceId");
